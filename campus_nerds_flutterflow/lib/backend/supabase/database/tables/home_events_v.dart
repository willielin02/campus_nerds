...
class HomeEventsVTable extends SupabaseTable<HomeEventsVRow> {
  @override
  String get tableName => 'home_events_v';

  @override
  HomeEventsVRow createRow(Map<String, dynamic> data) => HomeEventsVRow(data);
}

class HomeEventsVRow extends SupabaseDataRow {
  HomeEventsVRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => HomeEventsVTable();
  ...
  bool? get hasConflictSameSlot => getField<bool>('has_conflict_same_slot');
  set hasConflictSameSlot(bool? value) =>
      setField<bool>('has_conflict_same_slot', value);
}
