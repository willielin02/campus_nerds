...
import 'games_booking_confirmation_model.dart';
export 'games_booking_confirmation_model.dart';

class GamesBookingConfirmationWidget extends StatefulWidget {
  const GamesBookingConfirmationWidget({
    super.key,
  ...
  static String routeName = 'GamesBookingConfirmation';
  static String routePath = '/gamesBookingConfirmation';

  @override
  State<GamesBookingConfirmationWidget> createState() =>
      _GamesBookingConfirmationWidgetState();
}

class _GamesBookingConfirmationWidgetState
    extends State<GamesBookingConfirmationWidget> {
  late GamesBookingConfirmationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GamesBookingConfirmationModel());
                                  ...
                                  if (currentUserUid != null &&
                                    ...
                                    if (_model.loggedInUser?.firstOrNull
                                      ...
                                      if ((_model.loggedInUser?.firstOrNull
                                        ...
                                        if (_model.userBalanceGames!
                                                .firstOrNull!.gamesBalance! >
                                            0) {
                                          await showDialog(
                                            context: context,
                                              ...
                                              return Dialog(
                                                ...
                                                child: WebViewAware(
                                                  child: GestureDetector(
                                                    ...
                                                    child:
                                                        ConfirmDialogCreateBookingGamesWidget(
