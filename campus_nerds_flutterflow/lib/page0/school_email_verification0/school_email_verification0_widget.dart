...
import 'school_email_verification0_model.dart';
export 'school_email_verification0_model.dart';

class SchoolEmailVerification0Widget extends StatefulWidget {
  const SchoolEmailVerification0Widget({super.key});

  static String routeName = 'SchoolEmailVerification0';
  static String routePath = '/schoolEmailVerification0';

  @override
  State<SchoolEmailVerification0Widget> createState() =>
      _SchoolEmailVerification0WidgetState();
}

class _SchoolEmailVerification0WidgetState
    extends State<SchoolEmailVerification0Widget>
    with TickerProviderStateMixin {
  late SchoolEmailVerification0Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SchoolEmailVerification0Model());
