...
import '/popout_dialog/confirm_dialog_create_booking_study/confirm_dialog_create_booking_study_widget.dart';
import 'dart:ui';
import '/index.dart';
...
import 'study_booking_confirmation_model.dart';
export 'study_booking_confirmation_model.dart';

class StudyBookingConfirmationWidget extends StatefulWidget {
  const StudyBookingConfirmationWidget({
    super.key,
  ...
  static String routeName = 'StudyBookingConfirmation';
  static String routePath = '/studyBookingConfirmation';

  @override
  State<StudyBookingConfirmationWidget> createState() =>
      _StudyBookingConfirmationWidgetState();
}

class _StudyBookingConfirmationWidgetState
    extends State<StudyBookingConfirmationWidget> {
  late StudyBookingConfirmationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => StudyBookingConfirmationModel());
                                      ...
                                      if ((_model.loggedInUser?.firstOrNull
                                          ...
                                          (_model.loggedInUser?.firstOrNull
                                              ...
                                              _model.loggedInUser?.firstOrNull
                                                      ?.os !=
                                                  '')) {
                                        _model.userBalanceStudy =
                                            await UserTicketBalancesVTable()
                                                .queryRows(
                                          queryFn: (q) => q.eqOrNull(
                                            'user_id',
                                            currentUserUid,
                                        ...
                                        if (_model.userBalanceStudy!
                                                .firstOrNull!.studyBalance! >
                                            0) {
                                          await showDialog(
                                            context: context,
                                              ...
                                              return Dialog(
                                                ...
                                                child: WebViewAware(
                                                  child: GestureDetector(
                                                    ...
                                                    child:
                                                        ConfirmDialogCreateBookingStudyWidget(
