...
import 'city_selector_bottom_sheet_study_model.dart';
export 'city_selector_bottom_sheet_study_model.dart';

class CitySelectorBottomSheetStudyWidget extends StatefulWidget {
  const CitySelectorBottomSheetStudyWidget({super.key});

  @override
  State<CitySelectorBottomSheetStudyWidget> createState() =>
      _CitySelectorBottomSheetStudyWidgetState();
}

class _CitySelectorBottomSheetStudyWidgetState
    extends State<CitySelectorBottomSheetStudyWidget> {
  late CitySelectorBottomSheetStudyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CitySelectorBottomSheetStudyModel());
                    ...
                    children: [
                      Opacity(
                        opacity: valueOrDefault<double>(
                          FFAppState().queryEventsForTaipeiStudyCounts == 0
                              ? 0.22
                              : 1.0,
                          1.0,
                        ),
                        child: InkWell(
                          ...
                          onTap: () async {
                            if (FFAppState().queryEventsForTaipeiStudyCounts !=
                                0) {
                      ...
                      Opacity(
                        ...
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            if (FFAppState().queryEventsForTaoyuanStudyCounts !=
                                0) {
                      ...
                      Opacity(
                        opacity: valueOrDefault<double>(
                          FFAppState().queryEventsForHsinchuStudyCounts == 0
                              ? 0.22
                              : 1.0,
                          1.0,
                        ),
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            if (FFAppState().queryEventsForHsinchuStudyCounts !=
                                0) {
                      ...
                      Opacity(
                        opacity: valueOrDefault<double>(
                          FFAppState().queryEventsForTaichungStudyCounts == 0
                              ? 0.22
                              : 1.0,
                          1.0,
                        ),
                      ...
                      Opacity(
                        opacity: valueOrDefault<double>(
                          FFAppState().queryEventsForChiayiStudyCounts == 0
                              ? 0.22
                              : 1.0,
                          1.0,
                        ),
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            if (FFAppState().queryEventsForChiayiStudyCounts !=
                                0) {
                      ...
                      Opacity(
                        opacity: valueOrDefault<double>(
                          FFAppState().queryEventsForTainanStudyCounts == 0
                              ? 0.22
                              : 1.0,
                          1.0,
                        ),
                        child: InkWell(
                          ...
                          highlightColor: Colors.transparent,
                          onTap: () async {
                            if (FFAppState().queryEventsForTainanStudyCounts !=
                                0) {
                      ...
                      Opacity(
                        opacity: valueOrDefault<double>(
                          FFAppState().queryEventsForKaohsiungStudyCounts == 0
                              ? 0.22
                              : 1.0,
                          1.0,
                        ),
